"""
NOT USED IN THE FINAL VERSION OF THE THESIS
"""
...
from training_models import UNet_original, UNet_original_v2
...
if __name__ == "__main__":
    ...
    if ultrasound:
        model = UNet_original_v2().to(device)
    else:
    ...
    # wandb.init(config=config, project="master_thesis", name="UNet_original_no_ultrasound")
            ...
            with torch.no_grad():
                ...
                if counter >= patience:
                    ...
                    if val_loss < best_val_loss:
                        ...
                        counter = 0
                        torch.save(model.state_dict(), "/data/UNet_original_no_ultrasound.pth")
                    else:
                        counter += 1
    ...
    model.load_state_dict(torch.load("/data/UNet_original_no_ultrasound.pth", map_location=device))
